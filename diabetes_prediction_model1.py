...
for col in cols:
    df[col]=RobustScaler().fit_transform(df[[col]])#Veriyi -1 1 aralağı ve çevresine eşitler!
df.head()
...
"""def plot_confusion_matrix(y,y_pred):
    ...
    plt.show()
plot_confusion_matrix(y,y_pred)"""#Lazım Olursa /classification_report/ methodunun fonksiyon hali!
...
random_user = X.sample(1, random_state=4825)
a=log_model.predict(random_user)
print(a)
